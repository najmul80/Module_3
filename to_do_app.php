...
// TODO: Define a constant for the tasks file (task.json)
...
$tasks = loadTasks();
// TODO: Create a function  to save tasks from the tasks.json file
...
<head>
    ...
    <style>
        ...
        .task-card{
            border: 1px solid #ececec; /* Outline color */
            padding: 20px;
            border-radius: 5px;
            background: #fff;
        ...
        <div class="task-card">
            ...
            <ul style="list-style: none; padding:0;">
                ...
                <?php foreach($tasks as $index=> $task): ?>
                    <li class="task-item">
                        <form style="flex-grow: 1;" method="post">
